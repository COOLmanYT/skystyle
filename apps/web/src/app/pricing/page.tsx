...
const plans = [
  { name: "Free", price: "A$0", note: "For everyday weather-aware outfit checks.", items: ["20 AI recommendations each day", "Real-time multi-source weather", "Manual or GPS location", "Up to 3 active API keys"] },
