...
- **Build:** `npm run build` · **Lint:** `npm run lint` (targets `apps/web`) · **Tests:** `npm test` (Jest).
...
- **Rate limits:** `free` 20 AI/day · `demo` 10× free · `pro` credits · `dev` unlimited (`apps/web/src/lib/daily-usage.ts`).
